...
import { Save, Bell, Moon, Sun, Lock, Globe } from 'lucide-react';
                        ...
                        <div className={`p-6 rounded-2xl border shadow-sm ${isDarkMode ? 'bg-gray-900 border-gray-800' : 'bg-white border-gray-100'}`}>
                            ...
                            <form onSubmit={handleSave} className="space-y-4">
                                <div className="grid grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <input
                                            ...
                                            className={`w-full p-2 rounded-lg border ${isDarkMode ? 'bg-gray-800 border-gray-700 text-white' : 'border-gray-200'}`}
                                        />
                                    </div>
                                    <div>
                                ...
                                <div>
                                    ...
                                    <input
                                        disabled
                                        value={profile.email} // Fixed: was user?.email
                        ...
                        <div className={`p-6 rounded-2xl border shadow-sm ${isDarkMode ? 'bg-gray-900 border-gray-800' : 'bg-white border-gray-100'}`}>
                            ...
                            <div className="space-y-4">
                                <div className="flex items-center justify-between p-3 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors">
                                    ...
                                    <button
                                        onClick={toggleTheme}
                                        className={`w-12 h-6 rounded-full p-1 transition-colors ${isDarkMode ? 'bg-purple-600' : 'bg-gray-200'}`}
                                    >
